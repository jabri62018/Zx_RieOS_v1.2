...
This repository contains the complete code and data for the paper: **"Zx_RieOS v1.2: A 4+1D Geometric Resonance Theory with Z + C + A = 1 Unifying Quantum and Cosmic Physics"**

**Paper DOI:** [10.5281/zenodo.20114317](https://doi.org/10.5281/zenodo.20114317) | **CERN** ✅

**Preprint:** [viXra:18005360](https://vixra.org/abs/1800.5360) | Submitted 2018-10-10 | Status: Under Review

**GitHub Release:** [v1.2.1](https://github.com/jabri62018/Zx_RieOS_v1.2/releases/tag/v1.2.1)
...
```python
!git clone https://github.com/jabri62018/Zx_RieOS_v1.2.git
%cd Zx_RieOS_v1.2
!python Zx_all.py
